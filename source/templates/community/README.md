<table>
  ...
  Community templates are a way to use official releases of [kjanat/metrics](https://github.com/kjanat/metrics) while using templates from external repositories (owned or not).
...
with:
  ...
  template: "@classic"
  setup_community_templates: kjanat/metrics@master:classic
...
with:
  token: ${{ secrets.METRICS_TOKEN }}
  template: "@terminal"
  setup_community_templates: kjanat/metrics@master:terminal+trust
